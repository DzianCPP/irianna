...
document.addEventListener("DOMContentLoaded", function () {
    document.getElementById("main-client-currency").addEventListener("click", function () {
        document.getElementById("total-currency").innerHTML = document.getElementById("main-client-currency").value;
    });
});

document.addEventListener("DOMContentLoaded", function () {
    document.getElementById("main-client-currency-1").addEventListener("click", function () {
