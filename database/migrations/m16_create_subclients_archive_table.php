...
class m16_create_subclients_archive_table extends BaseMigration
{
    public function up(): bool
    {
        ...
        $sqlQuery = "CREATE TABLE IF NOT EXISTS subclients_archive_table (
    ...
    public function down(): bool
    {
        ...
        $sqlQuery = "DROP TABLE IF EXISTS subclients_archive_table";
