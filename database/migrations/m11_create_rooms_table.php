...
class m11_create_rooms_table extends BaseMigration
{
    public function up(): bool
    {
        ...
        $sqlQuery = "CREATE TABLE IF NOT EXISTS rooms_table (
                        ...
                        client_1_id int(20) DEFAULT 0,
                        client_2_id int(20) DEFAULT 0,
                        client_3_id int(20) DEFAULT 0,
                        client_4_id int(20) DEFAULT 0,
                        client_5_id int(20) DEFAULT 0,
                        client_6_id int(20) DEFAULT 0,
                        client_7_id int(20) DEFAULT 0,
                        client_8_id int(20) DEFAULT 0,
                        client_9_id int(20) DEFAULT 0,
                        client_10_id int(20) DEFAULT 0,
