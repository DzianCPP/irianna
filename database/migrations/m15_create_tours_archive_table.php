...
class m15_create_tours_archive_table extends BaseMigration
{
    public function up(): bool
    {
        ...
        $sqlQuery = "CREATE TABLE IF NOT EXISTS tours_archive_table (
                        ...
                        owner_travel_cost varchar(256) DEFAULT NULL,
                        number_of_children int(11) DEFAULT NULL,
                        ages varchar(255) DEFAULT NULL,
                        total_travel_service_byn int(11) DEFAULT NULL,
                        total_travel_cost_byn varchar(256) DEFAULT NULL,
    ...
    public function down(): bool
    {
        ...
        $sqlQuery = "DROP TABLE IF EXISTS tours_archive_table";
