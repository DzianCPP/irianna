...
class ClientsModel extends Model implements ModelInterface
{
    protected array $fields = [
        ["name", "main_phone", "second_phone", "passport", "birth_date", "address", "travel_service", "travel_cost_currency_1", "travel_cost_currency_2", "id", "archived", "passport_expiration_date"],
        ["name", "passport", "birth_date", "travel_service", "travel_cost_currency_1", "travel_cost_currency_2", "main_client_id", "id", "archived", "passport_expiration_date"]
    ];
