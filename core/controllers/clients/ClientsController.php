...
class ClientsController extends BaseController implements ControllerInterface
{
    ...
    public function hotel_list(): void
    {
        ...
        foreach ($tours as $t) {
            ...
            $cell_html .= DateConverter::YMDtoDMY($main_client['birth_date'])
                    . " - "
                    . $main_client['passport']
                    . (empty($main_client['passport_expiration_date']) === true ? '' : " - ")
                    . (empty($main_client['passport_expiration_date']) === true ? '' : DateConverter::YMDtoDMY($main_client['passport_expiration_date']))
                    . "<br>"
                ;
            $guests[] = $main_client;
            ...
            foreach ($sub_clients as $sc) {
                ...
                $cell_html .= DateConverter::YMDtoDMY($sc['birth_date'])
                    . " - "
                    . $sc['passport']
                    . (empty($sc['passport_expiration_date']) === true ? '' : " - ")
                    . (empty($sc['passport_expiration_date']) === true ? '' : DateConverter::YMDtoDMY($sc['passport_expiration_date']))
                    . "<br>"
                ;
            }
